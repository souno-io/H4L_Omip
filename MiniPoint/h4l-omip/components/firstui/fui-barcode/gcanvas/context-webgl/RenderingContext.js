// 本文件由FirstUI授权予叶兴（手机号： 18      79 8 7 91549，身份证尾号： 05  591  6）专用，请尊重知识产权，勿私下传播，违者追究法律责任。
...
export default class WebGLRenderingContext {
    ...
    compileShader = function (shader) {// echo建议
        WebGLRenderingContext.GBridge.callNative(
            this._canvas.id,
    ...
    getFramebufferAttachmentParameter = function (target, attachment, pname) {
        ...
        switch (pname) {
            case GLenum.FRAMEBUFFER_ATTACHMENT_OBJECT_NAME:// 新特性待增加
