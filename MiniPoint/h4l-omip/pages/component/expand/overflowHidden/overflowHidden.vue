<!--本文件由FirstUI授权予叶兴（手机号：187  9  8  79  1 54 9，身份证尾号： 055 9   16）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-wrap">
		...
		<view class="fui-page__bd">
			...
			<view class="fui-oh__wrap">
				<fui-overflow-hidden :text="text" :rows="2"></fui-overflow-hidden>
			</view>
			...
			<view class="fui-oh__wrap">
				...
				<fui-button type="gray" width="400rpx" height="84rpx" :text="btnText" bold :margin="['48rpx','auto']"
					@click="readMore">
				</fui-button>
			</view>
		</view>
