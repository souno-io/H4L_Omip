<!--本文件由FirstUI授权予叶兴（手机号： 18  79 8 7 9 15   49，身份证尾号：0   5 5 916）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-wrap">
		...
		<view class="fui-page__bd">
			...
			<view class="fui-flex__center fui-flex__column">
				...
				<fui-button type="gray" width="400rpx" height="84rpx" text="带清空按钮" bold @click="btnTap(4)"></fui-button>
				<fui-button type="gray" width="400rpx" height="84rpx" text="暗黑模式" bold :margin="['24rpx']"
					@click="btnTap(5)"></fui-button>
				<fui-button type="gray" width="400rpx" height="84rpx" text="身份证键盘" bold @click="btnTap(6)"></fui-button>
				<fui-button type="gray" width="400rpx" height="84rpx" text="自定义插槽内容" :margin="['24rpx']" bold
					@click="btnClick">
				</fui-button>
			</view>
