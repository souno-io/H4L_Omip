<!--本文件由FirstUI授权予叶兴（手机号： 18 7 9  87  91 5 4 9，身份证尾号：0 5  5 91 6）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-wrap">
		...
		<view class="fui-page__bd">
			<fui-button type="gray" width="400rpx" height="84rpx" text="关闭按钮-左上" bold :margin="['24rpx']"
				@click="showPopup(1)"></fui-button>
			<fui-button type="gray" width="400rpx" height="84rpx" text="关闭按钮-右上" bold @click="showPopup(2)">
			</fui-button>
			<fui-button type="gray" width="400rpx" height="84rpx" text="关闭按钮-中下" bold :margin="['24rpx']"
				@click="showPopup(3)">
			</fui-button>
			<fui-button type="gray" width="400rpx" height="84rpx" text="无关闭按钮" bold @click="showPopup(4)">
			</fui-button>
		</view>
