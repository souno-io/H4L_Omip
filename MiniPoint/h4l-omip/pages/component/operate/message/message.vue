<!--本文件由FirstUI授权予叶兴（手机号：     1 87   987 91549，身份证尾号：05  5  9 16）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-wrap">
		...
		<view class="fui-page__bd">
			...
			<fui-button type="gray" width="400rpx" height="84rpx" text="自定义背景色" bold @click="showMsg(2)">
			</fui-button>
			<fui-button type="gray" width="400rpx" height="84rpx" text="带图标提示" bold :margin="['24rpx']"
				@click="showMsg(3)">
			</fui-button>
			<fui-button type="gray" width="400rpx" height="84rpx" text="设置显示时间" bold @click="showMsg(4)">
			</fui-button>
		</view>
