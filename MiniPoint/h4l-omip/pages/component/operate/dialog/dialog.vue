<!--本文件由FirstUI授权予叶兴（手机号： 1 8 7987    9   1549，身份证尾号：055  91   6）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-wrap">
		...
		<view class="fui-page__bd fui-page__spacing">
			...
			<fui-button type="gray" width="400rpx" height="84rpx" text="自定义按钮" bold @click="showDialog(2)">
			</fui-button>
		</view>
