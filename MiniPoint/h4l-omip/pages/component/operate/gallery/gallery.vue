<!--本文件由FirstUI授权予叶兴（手机号：187 98 7    91  5 4 9，身份证尾号：0 559  1  6）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-wrap">
		...
		<view class="fui-page__bd">
			<fui-button type="gray" width="400rpx" height="84rpx" text="自定义Gallery" bold :margin="['24rpx']"
				@click="showGallery"></fui-button>
			<fui-button type="gray" width="400rpx" height="84rpx" text="原生预览" bold @click="previewImage"></fui-button>
		</view>
