<!--本文件由FirstUI授权予叶兴（手机号：187   9 87 9 1 5 4  9，身份证尾号：0  5   5916）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-wrap">
		...
		<view class="fui-page__bd">
			...
			<fui-bubble-box :padding="['26rpx','30rpx']" background="#4c4c4c" color='#fff' lineColor="#666" :items="items" :show="show6"
