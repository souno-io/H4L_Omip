<!--本文件由FirstUI授权予叶兴（手机号：  187      98 79154 9，身份证尾号： 05   59 16）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-wrap">
		...
		<view class="fui-page__bd">
			...
			<view class="fui-section__title">数字节点</view>
			<fui-steps :items="items2" :current="current" activeColor="#FF2B2B"></fui-steps>
			...
			<fui-steps :items="items3" :current="current" isWait activeColor="#FFB703"></fui-steps>
			...
			<view class="fui-btn__box">
				<fui-button type="gray" width="400rpx" height="84rpx" text="Next step" bold :margin="['24rpx']"
