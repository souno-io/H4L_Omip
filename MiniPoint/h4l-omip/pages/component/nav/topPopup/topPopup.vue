<!--本文件由FirstUI授权予叶兴（手机号：  1 8 7 9 87   9154 9，身份证尾号：05 5  9  16）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-wrap">
		...
		<view class="fui-page__bd">
			...
			<fui-button type="gray" width="400rpx" height="84rpx" text="内容可滚动" :margin="['24rpx']" bold
				@click="showPopup(3)">
			</fui-button>
		</view>
