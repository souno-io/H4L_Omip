<!--本文件由FirstUI授权予叶兴（手机号： 1879   8 7 9  15 4 9，身份证尾号： 0  55 91 6）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
	<view class="fui-wrap">
		...
		<view class="fui-page__bd">
			<fui-button type="gray" width="400rpx" height="84rpx" text="基础使用" bold :margin="['24rpx']" @click="fab(1)">
			</fui-button>
			<fui-button type="gray" width="400rpx" height="84rpx" text="更换背景色" bold @click="fab(2)">
			</fui-button>
			<fui-button type="gray" width="400rpx" height="84rpx" text="图标换为文本" bold :margin="['24rpx']"
				@click="fab(3)">
			</fui-button>
			<fui-button type="gray" width="400rpx" height="84rpx" text="切换位置"  bold @click="fab(4)">
			</fui-button>
		</view>
