...
pluginName = null;
EAN13 = function() {
  EAN132.prototype.settings = {};
  EAN132.prototype.init = function() {
    var checkDigit, code;
  ...
  EAN132.prototype.getCode = function() {
  ...
  EAN132.prototype.clear = function(context) {
    return context.clearRect(0, 0, this.settings.width, this.settings.height);
  };
  EAN132.prototype.draw = function(code) {
  ...
  EAN132.prototype.generateCheckDigit = function(number) {
    var chars, counter;
    counter = 0;
    chars = number.split("");
    chars.forEach(function(value, key) {
