...
let calendar = {
  ...
  solar2lunar: function(y, m, d) {
    ...
    d = objDate.getDate();
    let offset = (Date.UTC(objDate.getFullYear(), objDate.getMonth(), objDate.getDate()) - Date.UTC(
      1900,
      0,
      31
    )) / 864e5;
    ...
    let firstNode = calendar.getTerm(year, m * 2 - 1);
    let secondNode = calendar.getTerm(year, m * 2);
    ...
    let dayCyclical = Date.UTC(y, sm, 1, 0, 0, 0, 0) / 864e5 + 25567 + 10;
  ...
  lunar2solar: function(y, m, d, isLeapMonth) {
    ...
    let calObj = new Date((offset + d - 31) * 864e5 + stmap);
