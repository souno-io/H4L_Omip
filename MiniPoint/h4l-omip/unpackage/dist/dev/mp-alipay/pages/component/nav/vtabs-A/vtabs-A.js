...
if (!Array) {
  ...
  (_easycom_fui_vtabs_content2 + _easycom_fui_vtabs2)();
}
...
if (!Math) {
  (_easycom_fui_vtabs_content + _easycom_fui_vtabs)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.f($data.vtabs, (item, index, i0) => {
      return {
        a: common_vendor.t(item.title || item.name),
        b: $data.resUrl + item.img,
        c: common_vendor.t(item.descr),
        d: $data.vtabs.length - 1 === index ? "800px" : "0",
        e: index,
        f: "3f6a77e0-1-" + i0 + ",3f6a77e0-0",
        g: common_vendor.p({
          tabIndex: index
        })
      };
    }),
    b: common_vendor.o($options.onTabClick),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/H4L_Omip/MiniPoint/h4l-omip/pages/component/nav/vtabs-A/vtabs-A.vue"]]);
