...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    d: common_vendor.o(($event) => $options.href("../updated/updated")),
    e: common_vendor.p({
      arrow: true
    }),
    f: common_vendor.o(($event) => $options.href("../vip/vip")),
    g: common_vendor.p({
      bottomLeft: "0",
      arrow: true
    }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/H4L_Omip/MiniPoint/h4l-omip/pages/my/about/about.vue"]]);
