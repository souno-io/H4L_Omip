    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('configuration', models.CharField(help_text='数据库链接串', max_length=1024, verbose_name='数据库链接串')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_datetime', models.DateTimeField(auto_now=True, help_text='修改时间', null=True, verbose_name='修改时间')),
                ('create_datetime', models.DateTimeField(auto_now_add=True, help_text='创建时间', null=True, verbose_name='创建时间')),
                ('file', models.FileField(default='avatar/default.png', help_text='存放文件字段', upload_to=common.utils.PathAndRename('avatar/2023-01-31/'), verbose_name='上传的文件')),
            ],
            options={
                'verbose_name': '上传文件',
